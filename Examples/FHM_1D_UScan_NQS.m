% Script for constructing and optimising Ansatz objects with spin-symmetric
% NQS Modifiers and Fermi sea References for the Fermi Hubbard model on a
...
Ref = {'SDet',0}; Mod = {'NQSTISS',1}; Alpha = 1;
...
% Add the fields necessary for the spin-symmetric NQS Modifier to be initialised.
Params.Nh = Alpha * N; Params.a = 0; Params.b = 0.01; Params.c = 0.01; 
Params.nmag = 0.05; Params.nphs = 0;
...
for u = 1:numel(U)
    if u > 1
        ...
        NewNQS = NQSTISS(HilbertObj,GraphObj,Params,1);
    ...
    RunTime = toc;
    save(['FHM U ' num2str(U(u)) ' N ' num2str(N) ' SDet-NQSTISS Alpha ' num2str(Alpha) ' Logs.mat'],'AnsatzObj','EnIter','RunTime');    
end