classdef NQSTIDDJ < NQS
    % NQSTIDDJ - a NQS Modifier variant designed to emulate the Jastrow
    % factor structure for fermionic systems, dealing with density terms. Replicates Jastrow in the limit of W(i,i) ->
    % Inf at Alpha = 1.
    ...
    methods
        ...
        function obj = NQSTIDDJ(Hilbert,Graph,Params,VFlag)
    ...
    methods (Static)
        ...
        function [dLogp] = LogDeriv(obj,Hilbert,Graph,Cfg)
            [dLogp] = LogDerivNQSTIDDJ(obj,Hilbert,Graph,Cfg);
        end
    end
