...
SR3 = SetSRTolerances(SR3,5/U(u)+2,1e-6); SR3 = SetEnergyTolerances(SR3,dEV3/U(u),0.05);
SR1 = SetLearnRate(SR1,LearnRate1(u)); SR1 = SetRegularisation(SR1,RegMax1(u),RegMin1(u),RegFac1(u));
SR2 = SetLearnRate(SR2,LearnRate2(u)); SR2 = SetRegularisation(SR2,RegMax2(u),RegMin2(u),RegFac2(u));
SR3 = SetLearnRate(SR3,LearnRate3(u)); SR3 = SetRegularisation(SR3,RegMax3(u),RegMin3(u),RegFac3(u));
tic;
