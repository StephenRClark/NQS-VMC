...
SamplerObj1 = SetNblock(SamplerObj1,N); SamplerObj1 = SetNequil(SamplerObj1,2500);

SamplerObj2 = SetNsamp(SamplerObj1,2000);
SamplerObj2 = SetNblock(SamplerObj2,N); SamplerObj2 = SetNequil(SamplerObj2,2500);

SamplerObj3 = SetNsamp(SamplerObj1,2000);
...
LR1 = N; LR2 = 0.5*N; LR3 = 0.1*N;
dEV1 = 1/U; dEV2 = 0.5/U; dEV3 = 0.2/U;
...
AnsStr = 'BECR-Jast Op6'; % Ansatz name string for easy identification later.
