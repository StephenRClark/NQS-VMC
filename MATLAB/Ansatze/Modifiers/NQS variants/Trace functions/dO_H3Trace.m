function [dF] = dO_H3Trace(Theta,Phi,Omega,HDim)
% Performs logarithmic derivative of trace w.r.t. hidden-cubed term Omega
...
dF = sum(((ones(numel(Theta),1)*(n.^3)) .* M),2)./sum(M,2);
