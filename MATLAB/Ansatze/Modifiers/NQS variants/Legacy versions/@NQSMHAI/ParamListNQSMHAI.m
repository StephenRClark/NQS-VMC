...
function [Params] = ParamListNQSMHAI(NQSObj)
...
Params((1:(Alpha*Nv))+2*(1+Alpha)) = reshape(NQSObj.WHv,Alpha*Nv,1);
Params((1:(Alpha*Nv))+2*(1+Alpha)+Alpha*Nv) = reshape(NQSObj.WMv,Alpha*Nv,1);
Params((1:(Alpha*Nv))+2*(1+Alpha)+2*Alpha*Nv) = reshape(NQSObj.XHv,Alpha*Nv,1);
Params((1:(Alpha*Nv))+2*(1+Alpha)+3*Alpha*Nv) = reshape(NQSObj.XMv,Alpha*Nv,1);
end