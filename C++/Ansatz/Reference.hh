// ------------------------------------------------------------------------------------------------------------
// Reference.hh - contains the definitions of the Reference object class, which is used as a component for the
//				  Ansatz object class. While most will be fixed and not contain variational parameters, 
//				  provisions for variational versions will be included here.
// ------------------------------------------------------------------------------------------------------------
...
namespace nqsvmc
{
	// Usage of Reference subclasses will be generating new pointers, so no implementer subclass.
	class Reference
	{
	public:
